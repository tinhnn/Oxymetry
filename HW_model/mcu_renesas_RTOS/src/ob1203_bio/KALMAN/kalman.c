...
const uint8_t max_alg_fail_cnt_init[] = { ZC_MAX_ALG_FAIL_COUNT, HR_MAX_ALG_FAIL_COUNT , SPO2_MAX_ALG_FAIL_COUNT ,RR_MAX_ALG_FAIL_COUNT, ZC_MAX_ALG_FAIL_COUNT};
const uint8_t max_outlier_cnt_init[] = {ZC_MAX_OUTLIER_COUNT , HR_MAX_OUTLIER_COUNT,  SPO2_MAX_OUTLIER_COUNT , RR_MAX_OUTLIER_COUNT, ZC_MAX_OUTLIER_COUNT};
const uint8_t max_data_length_init[] = {ZC_DATA_LENGTH, HR_DATA_LENGTH, SPO2_DATA_LENGTH, RR_DATA_LENGTH, ZC_DATA_LENGTH};
const uint8_t max_kalman_length_init[] = { ZC_KALMAN_LENGTH, HR_KALMAN_LENGTH, SPO2_KALMAN_LENGTH, RR_KALMAN_LENGTH, ZC_KALMAN_LENGTH};
const uint8_t min_data_std_init[] = { ZC_MIN_STD_1F , HR_MIN_STD_1F , SPO2_MIN_STD_1F , RR_MIN_STD_1F, B2B_MIN_STD_1F};
const uint8_t kalman_threshold_2x_init[] = { ZC_KALMAN_THRESHOLD_2X , HR_KALMAN_THRESHOLD_2X , SPO2_KALMAN_THRESHOLD_2X , RR_KALMAN_THRESHOLD_2X, B2B_KALMAN_THRESHOLD_2X};
const uint8_t jumps_ok_init[] = {NO_JUMPS, NO_JUMPS, JUMPS_OK, NO_JUMPS, NO_JUMPS, JUMPS_OK};
...
uint16_t array4[ZC_KALMAN_LENGTH]; //B2B is same length as ZC

uint16_t array5[ZC_DATA_LENGTH];
uint16_t array6[HR_DATA_LENGTH];
uint16_t array7[SPO2_DATA_LENGTH];
uint16_t array8[RR_DATA_LENGTH];
uint16_t array9[ZC_DATA_LENGTH]; //B2B is same length as ZC
